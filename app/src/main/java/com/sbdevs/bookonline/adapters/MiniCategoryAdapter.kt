...
class MiniCategoryAdapter(val list:ArrayList<String>):
    RecyclerView.Adapter<MiniCategoryAdapter.ViweHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MiniCategoryAdapter.ViweHolder {
    ...
    override fun onBindViewHolder(holder: MiniCategoryAdapter.ViweHolder, position: Int) {
