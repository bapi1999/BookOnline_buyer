...
import com.sbdevs.bookonline.seller.adapters.PaymentRequestAdapter
import com.sbdevs.bookonline.seller.models.PaymentRequestModel
...
class WithdrawalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        getBankDetails()
        getPaymentRequest()
        accountBalance = requireArguments().getInt("image_list",0)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.lay1.addNewUpi.setOnClickListener {
            val newIntent = Intent(requireContext(),SlAddBankDetailsActivity::class.java)
