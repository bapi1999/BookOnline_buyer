...
import com.sbdevs.bookonline.databinding.FragmentSlProductDetailsBinding
import com.sbdevs.bookonline.fragments.LoadingDialog
import com.sbdevs.bookonline.fragments.ProductImageFragment
...
import com.sbdevs.bookonline.seller.activities.EditProductActivity
import kotlinx.coroutines.*
import kotlinx.coroutines.tasks.await
import java.math.BigDecimal

class SlProductDetailsFragment : Fragment(),ProductImgAdapter.MyOnItemClickListener {

    private var _binding:FragmentSlProductDetailsBinding? =null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSlProductDetailsBinding.inflate(inflater, container, false)
        ...
        productDeleteWarningDialog.setContentView(R.layout.sle_product_delete_warning_dialog)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.lay1.changeProductImageBtn.setOnClickListener {
            val changeProductImageFragment = SlChangeProductImageFragment()
            ...
            val fragmentManager =
                parentFragmentManager.commit {
                    setReorderingAllowed(true)
                    add(R.id.fragment_container,changeProductImageFragment)
        ...
        firebaseFirestore.collection("PRODUCTS").document(productId).get()
            .addOnSuccessListener {
                if (it.exists()) {
                    ...
                    binding.lay3.replacementPolicyText.text = returnAvailable
                    ...
                    if (returnAvailable == "No Replacement Policy"){
                        val imgview = binding.lay3.replacementPolicyImg
                    ...
                    val adapter = ProductImgAdapter(productImgList,this@SlProductDetailsFragment)
