...
import com.sbdevs.bookonline.databinding.FragmentSlChangeProductImageBinding
import com.sbdevs.bookonline.fragments.LoadingDialog
import com.sbdevs.bookonline.seller.adapters.AlreadyUploadedImageAdapter
...
class SlChangeProductImageFragment : Fragment() , NewUploadImageAdapter.MyOnItemClickListener,
    AlreadyUploadedImageAdapter.AlreadyAddedImageClickListener {


    private var _binding: FragmentSlChangeProductImageBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSlChangeProductImageBinding.inflate(inflater, container, false)
