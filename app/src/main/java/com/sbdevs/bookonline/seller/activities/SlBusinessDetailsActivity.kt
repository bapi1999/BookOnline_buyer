...
import com.sbdevs.bookonline.databinding.ActivitySlBusinessDetailsBinding
...
class SlBusinessDetailsActivity : AppCompatActivity() {
    private lateinit var binding:ActivitySlBusinessDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySlBusinessDetailsBinding.inflate(layoutInflater)
        ...
        addressImage = businessLay.uploadAddressProfBtn
    ...
    private fun updateBusinessDetails() {
        ...
        firebaseFirestore.collection("USERS")
            ...
            document("BUSINESS_DETAILS").set(businessDetailsMap, SetOptions.merge())
        ...
        if (cameFrom=="edit"){
            //Do not send notification when edited
            Log.i("notification","edit")
        }else{
