...
import com.sbdevs.bookonline.databinding.ActivitySellerOrderDetailsBinding
...
class SellerOrderDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySellerOrderDetailsBinding.inflate(layoutInflater)
        setContentView(binding.root)
        orderId = intent.getStringExtra("orderId").toString().trim()
        viewProductBtn = binding.lay1.viewDetails
...
//        }
        ...
        binding.acceptOrderBtn.setOnClickListener {
            ...
            lay4.acceptImageButton.backgroundTintList = AppCompatResources
                .getColorStateList(this, R.color.successGreen)
        ...
        binding.packedBtn.setOnClickListener {
            ...
            lay4.packedImageButton.backgroundTintList = AppCompatResources
                .getColorStateList(this,R.color.blueLink)
        ...
        binding.shippedBtn.setOnClickListener {
            ...
            lay4.shippedImageButton.backgroundTintList = AppCompatResources
                .getColorStateList(this,R.color.indigo_500)
    ...
    private suspend fun getOrderDetails(orderId:String)  {
        ...
        firebaseFirestore.collection("ORDERS")
            ...
            .get().addOnSuccessListener {
                ...
                val timeAgo:String = FireStoreData().msToTimeAgo(this,orderTime)
...
//                    }
    ...
    private fun orderNew(orderTime:Date){
        ...
        lay4.orderImageButton.backgroundTintList = AppCompatResources
            .getColorStateList(this,R.color.amber_600)
    ...
    private fun orderDelivered(deliveredTime:Date){
        ...
        lay4.deliveredImageButton.backgroundTintList = AppCompatResources
            .getColorStateList(this,R.color.ratingGreen)
...
//
    ...
    private fun billingInvoiceTable(){
        ...
        val logo = AppCompatResources.getDrawable(this,R.drawable.books_online_buyer_logo)
